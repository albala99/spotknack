...
export declare type TweetV2LikedByResult = DataAndIncludeV2<UserV2[], ApiV2Includes>;
export declare type TweetV2RetweetResult = DataV2<{
    retweeted: boolean;
}>;
export declare type TweetV2RetweetedByResult = DataMetaAndIncludeV2<UserV2[], {
    result_count: number;
}, ApiV2Includes>;
